...
namespace Task_19
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                new Computer() { Id = 1, Name = "HP", Processor = "Intel", Frequency = 3.6, RAM = 16, VolumeHDD = 1000, MemoryVideo = 8, Cost = 100000, Count = 20 },
                ...
                new Computer() { Id = 6, Name = "ASUS", Processor = "Intel", Frequency = 2.8, RAM = 16, VolumeHDD = 500, MemoryVideo = 8, Cost = 50000, Count = 6 },
